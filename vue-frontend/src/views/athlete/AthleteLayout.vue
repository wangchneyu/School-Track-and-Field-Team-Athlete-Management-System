...
const navItems = [
  { path: '/athlete', label: '首页', icon: iconHome, exact: true },
  { path: '/athlete/scores', label: '成绩', icon: iconChart, exact: false },
  { path: '/athlete/checkin', label: '签到', icon: iconQR, exact: false },
  { path: '/athlete/attendance', label: '考勤', icon: iconClip, exact: false },
  { path: '/athlete/ratings', label: '评分', icon: iconStar, exact: false },
]

const sideItems = [
  { path: '/athlete', label: '我的主页', icon: iconHome, exact: true },
  { path: '/athlete/scores', label: '我的成绩', icon: iconChart, exact: false },
  { path: '/athlete/attendance', label: '我的考勤', icon: iconClip, exact: false },
  { path: '/athlete/ratings', label: '我的评分', icon: iconStar, exact: false },
  { path: '/athlete/checkin', label: '扫码签到', icon: iconQR, exact: false },
]
